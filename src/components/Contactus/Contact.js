...
const Contact = () => {
    useEffect(() => {
        document.title = "Harshil | Contact Us"
      }, [])
    return (
        <>
            <Particle/>
                                                    ...
                                                    <div className="mb-4 mb-sm-0">
                                                        ...
                                                        <div>
                                                            ...
                                                            <hr className="w-75 mb-3 border-dark-subtle"/>
                                                                <p className="mb-0">
                                                                    <a className="link-secondary text-decoration-none text-light" href="tel:+01234567890"  >(+91)01234567890</a>
                                                                </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="col-12 col-sm-6">
                                                    <div className="mb-4 mb-sm-0">
                                                        ...
                                                        <div>
                                                            ...
                                                            <hr className="w-75 mb-3 border-dark-subtle"/>
                                                                <p className="mb-0">
                                                                    <a className="link-secondary text-decoration-none text-light" href="mailto:gohilharshil858@gmail.com" >gohilharshil858<span className='text-white'>@</span>gmail.com</a>
                                                                </p>
                                                        </div>
                                                    </div>
                                                </div>
